...
const store = new Vuex.Store({
    state: {
        ...
        pathwayMembers: {
            ...
            'Chromatin_Remodeling-DNA_Methylation_path': ['ASXL1', 'DNMT3A', 'DOT1L', 'EZH2', 'IDH1', 'IDH2', 'IKZF1', 'KAT6A', 'KDM5A', 'KDM5C', 'KDM6A', 'KMT2D', 'MLL2', 'MRE11A', 'MSH2', 'MSH6', 'PBRM1', 'SETD2', 'TET2'],
